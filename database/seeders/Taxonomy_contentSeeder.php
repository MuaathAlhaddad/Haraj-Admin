...
class Taxonomy_contentSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $taxonomy_contents = array(
            ...
            array('title' => 'animals, livestock, and bird', 'description' => "categories", 'taxonomy_id' => $harajs_id, 'published_at' => now(), 'parent_id' => null, 'lang' => 'en', 'icon' => json_encode(['fas', 'fa-horse'])),
