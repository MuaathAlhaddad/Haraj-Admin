...
class Taxonomy_contentSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $taxonomy_contents = array(
            // harajs
            array('title' => 'cars', 'description' => "all ads about cars", 'taxonomy_id' => $harajs_id, 'published_at' => now(), 'parent_id' => null, 'lang' => 'en', 'icon' => json_encode(['fa', 'fa-car'])),
            array('title' => 'devices', 'description' => "all ads about devices including electronics...", 'taxonomy_id' => $harajs_id, 'published_at' => now(), 'parent_id' => null, 'lang' => 'en', 'icon' => json_encode(['fa' , 'fa-desktop'])),
            array('title' => 'real estate', 'description' => "all ads that deals with buying, selling, management, or investment of real estate properties.", 'taxonomy_id' => $harajs_id, 'published_at' => now(), 'parent_id' => null, 'lang' => 'en', 'icon' => json_encode(['fa', 'fa-home'])),
            array('title' => 'animals, livestock, and bird', 'description' => "categories", 'taxonomy_id' => $harajs_id, 'published_at' => now(), 'parent_id' => null, 'lang' => 'en', 'icon' => json_encode(['fas', 'fa-dog'])),
            array('title' => 'personal accessories', 'description' => "categories", 'taxonomy_id' => $harajs_id, 'published_at' => now(), 'parent_id' => null, 'lang' => 'en', 'icon' => json_encode(['fas', 'fa-keyboard'])),
            array('title' => 'services', 'description' => "categories", 'taxonomy_id' => $harajs_id, 'published_at' => now(), 'parent_id' => null, 'lang' => 'en', 'icon' => json_encode(['fas', 'fa-concierge-bell'])),
            array('title' => 'food and beverages', 'description' => "categories", 'taxonomy_id' => $harajs_id, 'published_at' => now(), 'parent_id' => null, 'lang' => 'en', 'icon' => json_encode(['fas', 'fa-pizza-slice'])),
            array('title' => 'games and entertainment', 'description' => "categories", 'taxonomy_id' => $harajs_id, 'published_at' => now(), 'parent_id' => null, 'lang' => 'en', 'icon' => json_encode(['fas', 'fa-gamepad'])),
            array('title' => 'hunting and trips', 'description' => "categories", 'taxonomy_id' => $harajs_id, 'published_at' => now(), 'parent_id' => null, 'lang' => 'en', 'icon' => json_encode(['fas', 'fa-fish'])),
            array('title' => 'programming and designs', 'description' => "categories", 'taxonomy_id' => $harajs_id, 'published_at' => now(), 'parent_id' => null, 'lang' => 'en', 'icon' => json_encode(['fab', 'fa-free-code-camp'])),
            array('title' => 'parties and events', 'description' => "categories", 'taxonomy_id' => $harajs_id, 'published_at' => now(), 'parent_id' => null, 'lang' => 'en', 'icon' => json_encode(['fas', 'fa-birthday-cake'])),
            array('title' => 'library and arts', 'description' => "categories", 'taxonomy_id' => $harajs_id, 'published_at' => now(), 'parent_id' => null, 'lang' => 'en', 'icon' => json_encode(['fas', 'fa-book-reader'])),
            array('title' => 'travel and tourism', 'description' => "categories", 'taxonomy_id' => $harajs_id, 'published_at' => now(), 'parent_id' => null, 'lang' => 'en', 'icon' => json_encode(['fas', 'fa-plane'])),
            array('title' => 'others', 'description' => "all ads with different categories", 'taxonomy_id' => $harajs_id, 'published_at' => now(), 'parent_id' => null, 'lang' => 'en', 'icon' => json_encode(['fas', 'fa-ellipsis-h'])),
        );
        ...
        $taxonomy_contents = array(
            array('title' => '1996', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '1997', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '1998', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '1999', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2000', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2001', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2002', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2003', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2004', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2005', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2006', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2007', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2008', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2009', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2010', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2011', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2012', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2013', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2014', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2015', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2016', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2017', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2018', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2019', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2020', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
            array('title' => '2021', 'description' => "car model", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $cars_id, 'lang' => 'en'),
        );
        ...
        $taxonomy_contents = array(
            array('title' => 'samsung a12 nacho', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy m21 2021 edition', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy f22', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy a22', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy m32', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy a22 5g', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy f52 5g', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy quantum 2', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy f02s', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy f12', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy m42 5g', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy xcover 5', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy a52 5g', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy a52', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy a72', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy f62', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy m12', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy m02', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy a02', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy a32 5g', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy m02s', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy s21 ultra', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy s21+', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy s21', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy a02s', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy a12', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy m21s', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung w21 5g', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy f41', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy a3 core', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy s20 fe', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy a42 5g', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy z fold 2', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy m51', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy note 20 ultra 5g', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy note 20 5g', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
            array('title' => 'samsung galaxy note 20 ultra', 'description' => "samsung brand", 'taxonomy_id' => $models_id, 'published_at' => now(), 'parent_id' => $samsung_id, 'lang' => 'en'),
        );
